...
#ifndef DYNAMIC_EMBEDDING_SERVER_CC_FRAMEWORK_ELASTIC_GRPC_SERVER_LIB_H_
#define DYNAMIC_EMBEDDING_SERVER_CC_FRAMEWORK_ELASTIC_GRPC_SERVER_LIB_H_
...
#endif  // DYNAMIC_EMBEDDING_SERVER_CC_FRAMEWORK_ELASTIC_GRPC_SERVER_LIB_H_
